...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: 'Bookkeeping and Auditing',
        href: '/services/bookkeeping',
        children: [
          { label: 'Basic Bookkeeping and MIS', href: '/services/bookkeeping/basic' },
          ...
          { label: 'Accounting Staffing Solutions', href: '/services/bookkeeping/staffing' },
          { label: 'Backlog Accounting', href: '/services/bookkeeping/backlog' },
        ],
      },
      {
        label: 'VAT Advisory Services',
        href: '/services/vat',
        children: [
      ...
      {
        label: 'Other Compliance Services',
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Cost Control Strategy', href: '/services/cfo/cost-control' },
        ],
      },
      {
        label: 'UAE Residency Services',
